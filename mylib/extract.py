...
FILESTORE_PATH = "dbfs:/FileStore/individual_project_3"
...
def extract(
        url="""https://raw.githubusercontent.com/fivethirtyeight/data/master/womens-world-cup-predictions/wwc-matches-20150602-093000.csv?raw=true""",
        ...
        file_path=FILESTORE_PATH+"/wwc_matches_1.csv",
        file_path2=FILESTORE_PATH+"/wwc_matches_2.csv",
