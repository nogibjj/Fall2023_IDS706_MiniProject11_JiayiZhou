...
def load(dataset="dbfs:/FileStore/individual_project_3/wwc_matches_1.csv", 
         dataset2="dbfs:/FileStore/individual_project_3/wwc_matches_2.csv"):
    ...
    serve_times_df.write.format("delta").mode("overwrite").saveAsTable("wwc_matches_1_delta")
    event_times_df.write.format("delta").mode("overwrite").saveAsTable("wwc_matches_2_delta")
